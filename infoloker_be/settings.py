"""
Django settings for infoloker_be project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-jfs29ehuh*ks%*i%1r6fv88@tg(6*+crb0)rski-4om(1=jyg6')
...
ROOT_URLCONF = 'infoloker_be.urls'
...
WSGI_APPLICATION = 'infoloker_be.wsgi.application'
